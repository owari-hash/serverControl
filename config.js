...
module.exports = {
  ...
  AUTH_USE_HTTP_ONLY_COOKIE:
    String(process.env.AUTH_USE_HTTP_ONLY_COOKIE || "true").toLowerCase() ===
    "true",
  ...
  SSH_COMMAND_TIMEOUT_MS: parseInt(
    process.env.SSH_COMMAND_TIMEOUT_MS || "60000",
  ),
};
